...
const App = () => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      const response = await axios.post('https://leomongodb-9nn27c7pn-leocabs29s-projects-3747cf8b.vercel.app/api/user/register', formData);
  ...
  useEffect(() => {
    ...
    const fetchUsers = async () => {
      try {
        // Change URL to the correct endpoint
        const response = await axios.get('https://leomongodb-9nn27c7pn-leocabs29s-projects-3747cf8b.vercel.app/api/users');
